package com.tareqrobin.loginsignup;
...
public class RegistrationActivity extends Activity implements OnClickListener, OnItemSelectedListener
...

{
    ...
    protected DBHelper DB = new DBHelper(RegistrationActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<Model> spinnerArrayAdapter = new ArrayAdapter<Model>(this,
                android.R.layout.simple_spinner_item, new Model[] {
                new Model("Male"),
                new Model("Female")});
        ...
        switch(v.getId()){
            ...
            case R.id.submit:
                ...
                if(invalid == false)
                {
                    ...
                    Intent i_register = new Intent(RegistrationActivity.this, MainActivity.class);
    ...
    {
        // Get the currently selected Model object from the spinner
        Model st = (Model)mGender.getSelectedItem();
    ...
    public void toastState(String name, Model st)
    {
        if ( st != null )
        {
            Gen = st.name;
